      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            ...
            <p className="text-slate-500">
              <span className="font-bold text-amber-600">{needs.length} besoins</span> urgents recensés à Ksar El Kébir
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col justify-center items-center h-64 text-amber-500">
            ...
            <p className="text-slate-500 font-medium">Chargement des besoins...</p>
          </div>
        ) : (
          // Grille des cartes
              ...
              .map((need) => (
                <NeedCard 
                  ...
                  data={{
                    ...
                    timeAgo: new Date(need.createdAt).toLocaleDateString('fr-MA', { day: 'numeric', month: 'long', hour: '2-digit', minute:'2-digit' }),
                    urgency: need.urgency as any,
                    status: need.status === 'EN_ATTENTE' ? 'En attente' : need.status === 'EN_COURS' ? 'En cours' : 'Résolu',
